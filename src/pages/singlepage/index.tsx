      ...
      {cards.length > 0 ? (
        cards.map((card) => (
          <SwiperSlide key={card.id}>
            <div className="flex flex-col items-center shadow-md rounded-lg overflow-hidden transition-transform hover:scale-105 duration-300 ease-in-out">
              <img
                src={card.image}
                alt={`slide-${card.id}`}
              ...
              <div className="p-4 w-full">
                ...
                <div className="flex gap-3 mb-2 text-sm ">
                  ...
                  <div className="flex items-center gap-2">
                    <img src="images/Condition.png" alt="Condition Icon" className="w-5 h-5" />
                    <img src="images/euro.png" alt="Euro Icon" className="w-5 h-5" />
                  </div>
                </div>
